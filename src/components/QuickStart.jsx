  ...
  return (
    <div style={{ display: "flex", gap: "10px" }}>
      <Card
        ...
        title={
          <>
            <Text strong>3 Steps to Creating a DowryLink Contract</Text>
          </>
        }
      >
        <Timeline mode="left" style={styles.timeline}>
          <Timeline.Item dot="1">
            <Text>
              Acquire some DOWER token to place into your dowry contract.  Too expensive?  You can apply for a grant at the <a href="https://dower.in/dowerin-grants/" target="_blank">Dowerin Grants</a> page.
            </Text>
          </Timeline.Item>

          <Timeline.Item dot="2">
            <Text>
              Acquire some ETH and LINK token to enable the processing of your contract.
            </Text>
          </Timeline.Item>

          <Timeline.Item dot="3">
            <Text>
            Navigate to the <a href="https://app.dowrylink.com/contract">Contract Form</a> and complete your contract.  The finalized contract will be deployed to the Avalanche Network.
            </Text>
          </Timeline.Item>
